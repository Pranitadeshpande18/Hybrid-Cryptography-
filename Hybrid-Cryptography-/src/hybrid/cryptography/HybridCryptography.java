...
public class HybridCryptography extends JPanel implements ActionListener {
  ...
  public HybridCryptography() {
    ...
    //need to refer to it.
    log = new JTextArea("                                      Hybrid Cryptography",5,40);
...
//        }
  ...
  private static void createAndShowGUI() {
    ...
    JFrame frame = new JFrame("Hybrid Cryptography");
    
    //frame.setContentPane(new JLabel(new ImageIcon("C:\\Users\\Pranita Deshpande\\Documents\\Hybrid Cryptography[6211]\\Hybrid Cryptography\\src\\hybrid\\cryptography\\Cryptography.jpg")));
    //Create and set up the content pane.
    JComponent newContentPane = new HybridCryptography();
    newContentPane.setOpaque(true); //content panes must be opaque
    frame.setContentPane(newContentPane);
    //frame.setContentPane(new JLabel(new ImageIcon("C:\\Users\\Pranita Deshpande\\Documents\\Hybrid Cryptography[6211]\\Hybrid Cryptography\\src\\hybrid\\cryptography")));
